...
| `lander list [--since/--until <when>]` | List this project's tasks (id, status, title, created/updated timestamps), newest first; optionally bounded to a createdAt range. |
